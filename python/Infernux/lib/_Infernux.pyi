...
def _cds_alloc(class_id: int) -> int: ...
def _cds_free(class_id: int, slot: int) -> None: ...
def _cds_get(class_id: int, field_id: int, slot: int, type_code: int) -> Any: ...
def _cds_set(class_id: int, field_id: int, slot: int, type_code: int, value: Any) -> None: ...
